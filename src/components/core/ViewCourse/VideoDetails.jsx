...
const VideoDetails = () => {
  ...
  const goToNextVideo = () => {
    ...
    if (currentSubSectionIndx !== noOfSubsections - 1) {
      //same section ki next video mei jao
      const nextSubSectionId =  courseSectionData[currentSectionIndx].subSection
      [currentSubSectionIndx + 1]._id
      //next video par navigate
  ...
  const goToPrevVideo = () => {
    ...
    if (currentSubSectionIndx !== 0) {
      //same section mei previous video
